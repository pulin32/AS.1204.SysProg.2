...
// robottournament.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CrobottournamentApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CrobottournamentApp

CrobottournamentApp::CrobottournamentApp()
{
...
// Единственный объект CrobottournamentApp

CrobottournamentApp theApp;


// инициализация CrobottournamentApp

BOOL CrobottournamentApp::InitInstance()
{
